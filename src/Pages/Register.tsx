          ...
          <div className="col-xl-6 mx-auto">
            <div className="log-reg-form search-modal form-style1 bgc-white p50 p30-sm default-box-shadow1 bdrs12">
              <div className="mb30">
                ...
                <p className="text mt20">Already have an account? <a href="page-login.html" className="text-thm">Log In!</a></p>
              </div>
              <div className="mb25">
              ...
              <div className="mb25">
                ...
                <input type="email" className="form-control" placeholder="alitfn58@gmail.com" />
              </div>
              <div className="mb15">
