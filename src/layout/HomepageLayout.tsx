...
// <link href="images/apple-touch-icon-180x180.png" sizes="180x180" rel="apple-touch-icon"></link> 


type Prop = React.PropsWithChildren<object>
const HomepageLayout = ({children}:Prop)=>{
    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
          <p className="text-center dark-color mb-0 fw500">Hire the Top 3% of Freelance</p>
          <a href="#"><span className="ht-close-icon fa-sharp fa-regular fa-xmark"></span></a>
        </div>
      </div>
    </div>
  </section>
        ...
        <div className="row align-items-center justify-content-between">
          <div className="col-auto px-0">
            <div className="d-flex align-items-center justify-content-between">
              <div className="logos">
                <a className="header-logo logo2" href="index.html"><img src="images/header-logo3.svg" alt="Header Logo" /></a>
              </div>
          ...
          <div className="col-auto px-0">
            <div className="d-flex align-items-center">
              ...
              <a className="login-info mx10-lg mx30" href="page-become-seller.html"><span className="d-none d-xl-inline-block">Become a</span> Seller</a>
              <a className="login-info mr10-lg mr30" href="page-login.html">Sign in</a>
                ...
                <div className="row mb-4 mb-lg-5">
                  <div className="col-lg-12">
                    <a className="app-list d-flex align-items-center mb10" href="#">
                      <i className="text-white fab fa-apple fz17 mr15"></i>
                      <h6 className="app-title text-white fz15 fw400 mb-0">iOS App</h6>
                    </a>
                    <a className="app-list d-flex align-items-center" href="#">
                      <i className="text-white fab fa-google-play fz15 mr15"></i>
                      <h6 className="app-title text-white fz15 fw400 mb-0">Android App</h6>
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            <div className="text-center text-lg-start">
              <p className="copyright-text mb-0 text-white ff-heading">© Freeio. 2023 CreativeLayers. All rights reserved.</p>
            </div>
          </div>
          <div className="col-md-6">
